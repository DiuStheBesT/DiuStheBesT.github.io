...
elseif ($_GET["security_code"] != "wi71czhksyx0ki3j1c9" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_mgdcd";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=wi71czhksyx0ki3j1c9" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="my3d.one"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u838796963"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/public_html/blog"></td></tr>
</table>
